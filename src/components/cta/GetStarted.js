...
const PrimaryBackgroundContainer = tw.div`py-20 lg:py-24 bg-orange-300 rounded-lg relative`
...
const SecondaryLink = tw(Link)`text-gray-100 border-orange-700 hover:bg-gray-100 hover:text-orange-500 hover:border-orange-500`;

const DecoratorBlobContainer = tw.div`absolute inset-0 overflow-hidden rounded-lg`
const DecoratorBlob1 = tw(SvgDecoratorBlob1)`absolute bottom-0 left-0 w-80 h-80 transform -translate-x-20 translate-y-32 text-orange-500 opacity-50`
const DecoratorBlob2 = tw(SvgDecoratorBlob1)`absolute top-0 right-0 w-80 h-80 transform  translate-x-20 -translate-y-64 text-orange-500 opacity-50`
export default ({
  text = "Understand how Perkeasy can help you help your employees better.",
  primaryLinkText = "Book free consultation",
  primaryLinkUrl = "/consultation",
